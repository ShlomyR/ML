...
Button(root, text= 'The Photographer', font ='arial 20', command= madlib1, bg = 'ghost white').place(x=150, y=160)
Button(root, text= 'apple and apple', font ='arial 15', command = madlib3 , bg = 'ghost white').place(x=160, y=220)
Button(root, text= 'The Butterfly', font ='arial 15', command = madlib2, bg = 'ghost white').place(x=170, y=280)
